...
namespace Manntall.Backend.Migrations
{
    ...
    [Migration("20231208142435_Migration_AddOppholdsadresse")]
    partial class Migration_AddOppholdsadresse
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Manntall.Backend.Database.PersonEntity", b =>
                {
                    ...
                    b.OwnsOne("Manntall.Backend.Database.OppholdsAdresse", "Oppholdsadresse", b1 =>
                        {
                            b1.Property<Guid>("PersonEntityId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                            ...
                            b1.Property<string>("Adressegradering")
                                .IsRequired()
                                .HasColumnType("text")
                                .HasColumnName("oppholdsadresse_adressegradering");

                            b1.Property<string>("Adressenavn")
                                .HasColumnType("text")
                                .HasColumnName("oppholdsadresse_adressenavn");

                            b1.Property<string>("Adressenummer")
                                .IsRequired()
                                .HasColumnType("text")
                                .HasColumnName("oppholdsadresse_adressenummer");

                            b1.Property<string>("Adressetillegsnavn")
                                .HasColumnType("text")
                                .HasColumnName("oppholdsadresse_adressetillegsnavn");

                            b1.Property<string>("Bruksenhetsnummer")
                                .HasColumnType("text")
                                .HasColumnName("oppholdsadresse_bruksenhetsnummer");

                            b1.Property<string>("Bruksenhetstype")
                                .HasColumnType("text")
                                .HasColumnName("oppholdsadresse_bruksenhetstype");

                            b1.Property<string>("Kommunenummer")
                                .HasColumnType("text")
                                .HasColumnName("oppholdsadresse_kommunenummer");

                            b1.Property<string>("Postnummer")
                                .HasColumnType("text")
                                .HasColumnName("oppholdsadresse_postnummer");

                            b1.Property<string>("Poststed")
                                .HasColumnType("text")
                                .HasColumnName("oppholdsadresse_poststed");
